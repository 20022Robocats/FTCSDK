...
//import net.hypernite.projects.FTCUtils.AutoOp;

import org.firstinspires.ftc.robotcore.external.JavaUtil;
import org.firstinspires.ftc.teamcode.v2.*;

@Autonomous(
    name = Config.OpModeName + " - Autonomous",
    preselectTeleOp = Config.OpModeName + " - TeleOp"
)
...
//public class Main extends AutoOp<Robot.Drive, Robot.Arm, Robot, Config> {
//    public Main() { super(Config.class); }
//    public Robot robot;
//    private int ydefault;
//
//    public void onInit() {
//        robot = loadRobot();
//        ydefault = robot.getArm().motor0.getPos();
//    }
//
