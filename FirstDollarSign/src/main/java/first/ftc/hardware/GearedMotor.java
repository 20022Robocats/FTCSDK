...
public class GearedMotor {
    ...
    //////////////////////////////////////////////////
    /**
     * Default way rotation (should be only +-1)
     */
    private final double OFFSET;
    /**
     * Internal {@link DcMotor} it will interact with
     */
    private final DcMotor MOTOR;
    /**
     * Current {@link Gear} the motor is on
     */
    private Gear GEAR;
    /**
     * Creates a new Motor Instance
     */
    public GearedMotor(DcMotor motor, double offset) {
        this.MOTOR = motor;
